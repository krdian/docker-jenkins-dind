...
RUN apt-get update && apt-get install -y zip supervisor jenkins openjdk-8-jdk-headless && rm -rf /var/lib/apt/lists/*
...
CMD ["/usr/bin/supervisord","service docker start"]
